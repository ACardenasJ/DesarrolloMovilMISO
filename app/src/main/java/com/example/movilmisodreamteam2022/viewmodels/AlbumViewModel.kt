...
import com.example.movilmisodreamteam2022.repositories.AlbumRepository
...
class AlbumViewModel(application: Application) :  AndroidViewModel(application) {
    ...
    fun crearAlbum(body: JSONObject, callback: (JSONObject)->Unit, onError: (VolleyError)->Unit){
        albumRepository.postData(body, callback, onError)
    }
